...
import { CreatorInfo } from "./ui/creator-info";
import {
  Table,
  TableBody,
  TableCell,
    ...
    <div className="space-y-3">
      ...
      {!isLoading && creators.length === 0 && (
        <EmptyState
          ...
          description={"No creators found. Try again later."}
        />
      )}
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="bg-gray-50 dark:bg-white/5 rounded-lg p-2.5">
                  ...
                  <div className="text-lg font-bold text-gray-900 dark:text-white">
                    {(creator.influence_score ?? 0).toFixed(1)}
                  </div>
                </div>
                <div className="bg-gray-50 dark:bg-white/5 rounded-lg p-2.5">
                  <div className="text-[10px] text-gray-500 dark:text-white/50 mb-0.5 font-medium">
      ...
      {/* Desktop Table View */}
      {!isMobile && (creators.length > 0 || isLoading) && (
                      ...
                      <>
                        {creators.map((creator, index) => (
                          ...
                          >
                            ...
                            {/* Trending Score */}
                            <TableCell className="text-xs text-center font-bold text-gray-900 dark:text-white py-3">
                              {(creator.trending_score ?? 0).toFixed(1)}
                            </TableCell>
