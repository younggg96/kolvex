...
import { useTwitterPosts, usePostFilters } from "./hooks";
import { TwitterPostsContent } from "./components";
...
export default function TwitterPageClient() {
  ...
  // Convert to MultiSelect options with JSX icons
