...
class PrivacySettings(BaseModel):
    ...
    show_position_pnl: Optional[bool] = Field(None, description="Show total P&L per position")
    show_position_pnl_per_share: Optional[bool] = Field(None, description="Show P&L per share per position")
