"""Built-in stock universe used when the screener cache needs rebuilding."""
...
SP500_SYMBOLS = [
    ...
    "IQV", "IRM", "JBHT", "JBL", "JKHY", "J", "JNJ", "JCI", "JPM", "K",
    ...
    "PCAR", "PKG", "PLTR", "PANW", "PSKY", "PH", "PAYX", "PAYC", "PYPL",
